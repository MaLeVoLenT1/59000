#include "rampoven_calibration_zero.h"
#include "modbus.h"
...
rampoven_Calibration_Zero::rampoven_Calibration_Zero(QWidget *parent)
    : QDialog(parent){ui.setupUi(this);}
rampoven_Calibration_Zero::~rampoven_Calibration_Zero(){}

void rampoven_Calibration_Zero::WriteDataButton(void)
{
	MainWindow writeEM;
	int slaveID, addr;
	double valu;
...
void rampoven_Calibration_Zero::ReadDataButton(void)
{
