...
double _590_DID_DIG::detDIDSig(void){//ok - used for DID / FID- OK
	...
	/*
	 * Dione Changed double resultDsply; to double resultDsply = false; Because,
	 * The compiler wont know resultDsply is meant to 'initialize', it only sees the
	 * program tries to call a uninitialized variable. This removes a warning.
	 */
